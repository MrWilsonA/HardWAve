...
/**
 * `mark` renders the emblem alone — use it wherever the surrounding chrome
 * already supplies the wordmark (the navbar did, which double-printed the
 * brand). `full` renders the complete lockup for splash surfaces.
 */
type LogoVariant = "mark" | "full";

export default function HardWAveLogo({
  size = 38,
  variant = "full",
}: {
  size?: number;
